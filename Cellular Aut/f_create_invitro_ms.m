function [m_cell,m_GDNF] = f_create_invitro_ms(c_size,ck_dg,ck_gamma,ck_neighbours,ck_movement_rule,ck_moveprob_rule,ck_moving_rule)
% A function which allows user to input parameters and plots the result for
% the in vitro case
