function [c_heterogeneity,m_cell] = f_pmoveselector_m(c_x,c_y,m_allowedindices,m_cell,m_GDNF,v_parameters)
...
switch ck_moving_rule
    case 1 % All moves are given equal probability
        [c_heterogeneity,m_cell] = f_pmoving_rule1_m(c_x,c_y,m_allowedindices,m_cell,m_GDNF,v_parameters);
    case 2 % Move probability is weighted by the magnitude of the gradient of GDNF
        [c_heterogeneity,m_cell] = f_pmoving_rule2_m(c_x,c_y,m_allowedindices,m_cell,m_GDNF,v_parameters);
