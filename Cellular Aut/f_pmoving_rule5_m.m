...
c_denominator = 0;
for i = 1:cn_nummoves
    c_denominator = f_multinomial_logit_c(m_GDNF(m_allowedindices(i,1),m_allowedindices(i,2)) - m_GDNF(c_x,c_y),c_denominator);
end



for i = 1:cn_nummoves
    v_moves_param(i) = f_multinomial_logit_c(m_GDNF(m_allowedindices(i,1),m_allowedindices(i,2)) - m_GDNF(c_x,c_y),c_denominator);
end
