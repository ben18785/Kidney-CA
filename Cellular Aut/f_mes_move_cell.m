function cell_measurables = f_mes_move_cell(c_x,c_y,m_cell,m_GDNF,m_distance,v_parameters,cp_move_or_prolif)
...
[c_move,m_allowedindices] = f_prob_mes_move_c(c_x,c_y,m_GDNF,m_cell,m_distance,v_parameters,cp_move_or_prolif);
...
cell_measurables = f_mes_move_selector_m(c_x,c_y,m_allowedindices,m_cell,m_GDNF,m_distance,v_parameters,ck_mes_move_selector_rule,cp_move_or_prolif);
cell_measurables{4,1} = 0;