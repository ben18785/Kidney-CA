function [c_heterogeneity,m_cell] = f_pprolifselector_m(c_x,c_y,m_allowedindices,m_cell,m_GDNF,v_parameters)
...
switch ck_prolif_choosecell_rule
    case 1 % All moves are given equal probability
        [c_heterogeneity,m_cell] = f_pprolif_rule1_m(c_x,c_y,m_allowedindices,m_cell,m_GDNF,v_parameters);
    case 2 % Move probability is weighted by the magnitude of the gradient of GDNF
        [c_heterogeneity,m_cell] = f_pprolif_rule2_m(c_x,c_y,m_allowedindices,m_cell,m_GDNF,v_parameters);
