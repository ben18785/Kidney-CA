function cell_measurables = f_update_mesenchyme_m(c_x,c_y,m_cell,m_GDNF,m_wnt9b,v_parameters)
...
switch ck_mes_action
    case 1 % Move
        cell_measurables = f_mes_move_cell(c_x,c_y,m_cell,m_GDNF,v_parameters,1); % 1 here indicates that the action is a move
    case 2 % Proliferate
        cell_measurables = f_mes_move_cell(c_x,c_y,m_cell,m_GDNF,v_parameters,0); % 0 here indicates that the action is a proliferation
