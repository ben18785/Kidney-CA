function cell_measurables = f_update_moveprolif_m(c_x,c_y,m_cell,m_GDNF,v_parameters,c_ret);
% A function which either moves or proliferates the epithelium cell.
