function cell_measurables = f_prolif_epithelium_m(c_x,c_y,m_allowedindices,m_cell,m_GDNF,v_parameters,c_ret)
...
c_move = f_probprolif_c(c_x,c_y,m_allowedindices,m_GDNF,v_parameters,c_ret);
...
cell_measurables = f_pprolifselector_m(c_x,c_y,m_allowedindices,m_cell,m_GDNF,v_parameters,c_ret);
