function F = f_get_movie_invivo_cell_ret_duoexplant(c_T)
...
c_turn_on_active_mesenchyme = 0; % A switch to allow the user to turn on or off the updating of the mesenchyme
...
ck_mes_moveprob_rule2_discons_move_c2 = -0.05; % A parameter specifying how much to weigh against mesenchyme distant from epithelium moving. Should be negative
...
ck_move_norm_cons_rh = -50; % Constant C1 in rule f_probmove_rule2
ck_move_norm_slope_rh = 10; % Constant C2 in rule f_probmove_rule2
...
c_retlh_prob_GDNF_C0 = -10; % retL->retH GDNF probability constant
...
m_cell = f_create_random_epithelium_new_m(m_cell, c_depth_full/2,170, 500,v_parameters);
m_cell = f_create_random_epithelium_new_m(m_cell, c_depth_full/2,230, 500,v_parameters);
