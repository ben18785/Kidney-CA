function [m_cell,c_move,c_heterogeneity] = f_move_epithelium_m(c_x,c_y,m_allowedindices,m_cell,m_GDNF,v_parameters)
...
[c_heterogeneity,m_cell] = f_pmoveselector_m(c_x,c_y,m_allowedindices,m_cell,m_GDNF,v_parameters);
