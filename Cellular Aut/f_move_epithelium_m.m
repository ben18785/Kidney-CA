function cell_measurables = f_move_epithelium_m(c_x,c_y,m_allowedindices,m_cell,m_GDNF,v_parameters,c_ret)
...
c_move = f_probmove_c(c_x,c_y,m_allowedindices,m_GDNF,v_parameters,c_ret);
...
cell_measurables = f_pmoveselector_m(c_x,c_y,m_allowedindices,m_cell,m_GDNF,v_parameters,c_ret);
