function [m_cell,c_move,c_heterogeneity] = f_update_cell_m(v_coords_and_type,m_cell,m_GDNF,v_parameters)
...
switch c_celltype
    case 1
        [m_cell,c_move,c_heterogeneity] = f_update_epithelium_m(c_x,c_y,m_cell,m_GDNF,v_parameters);
    case -1
        c_move = 0;
        c_heterogeneity = 0;
