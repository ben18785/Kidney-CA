function m_wnt9b = f_field_update_wnt9b_m(m_cell,v_parameters)
% A function which updates thewnt9b field according to the locations of the
...
v_wnt9b = m_lap\v_rhs;
m_wnt9b = zeros(c_depth_full,c_width_full);

% Reshape the field into a matrix
for i = 1:c_depth_full
    for j = 1:c_width_full
        m_wnt9b(i,j) = v_wnt9b((i-1)*c_width_full + j);
    end
end
